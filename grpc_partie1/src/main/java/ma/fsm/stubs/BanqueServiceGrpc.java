...
public final class BanqueServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = ma.fsm.stubs.Bank.ConvertCurrencyRequest.class,
      responseType = ma.fsm.stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest, ma.fsm.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
      ...
      synchronized (BanqueServiceGrpc.class) {
        if ((getConvertMethod = BanqueServiceGrpc.getConvertMethod) == null) {
          BanqueServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<ma.fsm.stubs.Bank.ConvertCurrencyRequest, ma.fsm.stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BanqueService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.fsm.stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.fsm.stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest, ma.fsm.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest, ma.fsm.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest,
      ma.fsm.stubs.Bank.ConvertCurrencyResponse> getFullStreamMethod() {
    io.grpc.MethodDescriptor<ma.fsm.stubs.Bank.ConvertCurrencyRequest, ma.fsm.stubs.Bank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static abstract class BanqueServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(ma.fsm.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getCurrencyStream(ma.fsm.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyRequest> fullStream(
        io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ma.fsm.stubs.Bank.ConvertCurrencyRequest,
                ma.fsm.stubs.Bank.ConvertCurrencyResponse>(
  ...
  public static final class BanqueServiceBlockingStub extends io.grpc.stub.AbstractStub<BanqueServiceBlockingStub> {
     ...
     * </pre>
     */
    public ma.fsm.stubs.Bank.ConvertCurrencyResponse convert(ma.fsm.stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ma.fsm.stubs.Bank.ConvertCurrencyResponse> getCurrencyStream(
        ma.fsm.stubs.Bank.ConvertCurrencyRequest request) {
  ...
  public static final class BanqueServiceFutureStub extends io.grpc.stub.AbstractStub<BanqueServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ma.fsm.stubs.Bank.ConvertCurrencyResponse> convert(
        ma.fsm.stubs.Bank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((ma.fsm.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENCY_STREAM:
          serviceImpl.getCurrencyStream((ma.fsm.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.fsm.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BanqueServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ma.fsm.stubs.Bank.getDescriptor();
    }
